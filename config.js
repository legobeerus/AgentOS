module.exports = {
  ...
  VOTING_CHANNEL_ID: process.env.VOTING_CHANNEL_ID || "1060495855817334887",
  RESULT_CHANNEL_ID: process.env.RESULT_CHANNEL_ID || "1060501671639273472",
  LOG_CHANNEL_ID: process.env.LOG_CHANNEL_ID || "1433763933579251732"
};
